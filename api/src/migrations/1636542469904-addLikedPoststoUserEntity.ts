...
export class addLikedPoststoUserEntity1636542469904 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users_liked_posts_posts" ADD CONSTRAINT "FK_eb68cd8837fcd1bbaced863e8d3" FOREIGN KEY ("postsId") REFERENCES "posts"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
